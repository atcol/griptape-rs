...
pub async fn get_organization(configuration: &configuration::Configuration, organization_id: &str) -> Result<models::GetOrganizationResponseContent, Error<GetOrganizationError>> {
...
pub async fn list_organizations(configuration: &configuration::Configuration, ) -> Result<models::ListOrganizationsResponseContent, Error<ListOrganizationsError>> {
    let local_var_configuration = configuration;
