...
impl DataJobDetail {
    pub fn new(data_job_id: String, data_connector_id: String, created_at: String, created_by: String, status: models::DataJobStatus) -> DataJobDetail {
        DataJobDetail {
            data_job_id,
            data_connector_id,
            created_at,
