...
pub struct CancelStructureRunResponseContent {
...
impl CancelStructureRunResponseContent {
    pub fn new(structure_run_id: String, structure_id: String, created_by: String, created_at: String, started_at: String, updated_at: String, completed_at: String, status: models::StructureRunStatus, args: Vec<String>) -> CancelStructureRunResponseContent {
