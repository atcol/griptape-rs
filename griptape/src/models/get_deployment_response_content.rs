...
pub struct GetDeploymentResponseContent {
...
impl GetDeploymentResponseContent {
    pub fn new(deployment_id: String, structure_id: String, status: models::DeploymentStatus, code_source: models::CodeSource, created_by: String, created_at: String) -> GetDeploymentResponseContent {
