...
impl StructureRunDetail {
    pub fn new(structure_run_id: String, structure_id: String, created_by: String, created_at: String, started_at: String, updated_at: String, completed_at: String, status: models::StructureRunStatus, args: Vec<String>) -> StructureRunDetail {
        StructureRunDetail {
            structure_run_id,
            structure_id,
            created_by,
