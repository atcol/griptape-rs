...
impl IntegrationDetail {
    pub fn new(integration_id: String, name: String, description: String, config: models::IntegrationConfigUnion, r#type: models::IntegrationType, structure_ids: Vec<String>, assistant_ids: Vec<String>, created_at: String, updated_at: String, organization_id: String, created_by: String) -> IntegrationDetail {
        IntegrationDetail {
            integration_id,
            name,
            description,
