...
impl AssistantRunDetail {
    pub fn new(assistant_run_id: String, assistant_id: String, created_by: String, created_at: String, updated_at: String, completed_at: String, status: models::AssistantRunStatus, args: Vec<String>, knowledge_base_ids: Vec<String>, ruleset_ids: Vec<String>, stream: bool, structure_ids: Vec<String>) -> AssistantRunDetail {
        AssistantRunDetail {
            assistant_run_id,
            assistant_id,
            created_by,
