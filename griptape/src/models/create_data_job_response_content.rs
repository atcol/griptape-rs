...
pub struct CreateDataJobResponseContent {
...
impl CreateDataJobResponseContent {
    pub fn new(data_job_id: String, data_connector_id: String, created_at: String, created_by: String, status: models::DataJobStatus) -> CreateDataJobResponseContent {
