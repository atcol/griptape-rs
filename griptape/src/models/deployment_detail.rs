...
impl DeploymentDetail {
    pub fn new(deployment_id: String, structure_id: String, status: models::DeploymentStatus, code_source: models::CodeSource, created_by: String, created_at: String) -> DeploymentDetail {
        DeploymentDetail {
            deployment_id,
            structure_id,
            status,
